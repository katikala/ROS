...
@Component({
  selector: 'ngx-myprofile-action-cell-renderer',
  template:`<div class="">
  <i
    ...
    (click)="viewDocument()"
  ></i>
  <i class="fa fa-download ml-2" aria-hidden="true" (click)="downloadDocument()" style="cursor: pointer; 
  vertical-align: middle;
  margin-right: 10px;"></i> 
  <i
...
export class MyprofileActionCellRendererComponent implements OnInit {
